...
<div x-data="{ show: true }" 
    ...
    <div class="px-6 py-4 rounded-lg shadow-lg bg-white border-l-4 
    ...
    <div x-data="{ showInputForm: true }" class="min-h-screen bg-gray-900 flex flex-col items-center py-8 text-white">
        <div class="w-full max-w-3xl px-4">
            ...
            <div class="text-center mb-8">
                <h1 class="text-3xl font-bold bg-gradient-to-r from-indigo-400 to-purple-500 bg-clip-text text-transparent">
                    AI Email Assistant
                </h1>
                    ...
                    <form wire:submit.prevent="generateEmail" class="space-y-4 p-4">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="text-red-400 text-sm">
                                ...
                                @error('cc') {{ $message }} @enderror
                                @error('subject') {{ $message }} @enderror
                                @error('content') {{ $message }} @enderror
                                @error('command') {{ $message }} @enderror
                                @if ($errors->has('api'))
                                    <div class="text-red-400 text-sm">
                                        ⚠️ {{ $errors->first('api') }}
                                    </div>
                            ...
                            <div class="space-y-3 text-gray-300">
                                ...
                                <div class="flex items-center space-x-2 text-sm">
                                    ...
                                    <button wire:click="sendMail"
                                        ...
                                        <span wire:loading wire:target="sendMail">
                                            <svg class="inline animate-spin h-4 w-4 ml-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                                <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                            </svg>
                                        </span>
                                ...
                                <div class="pt-4 border-t border-gray-700/50">
                                    ...
                                    <div class="mt-2 text-xs text-gray-500">
                                        Example commands: "make it shorter", "add call-to-action", "use more formal tone"
                                    </div>
                                </div>
                            </div>
                        </div>
